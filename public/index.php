...
$huissierRepo = new HuissiersRepository();

var_dump($huissierRepo->create(["name" => "mohammed", "age" => 23, "iq" => 190, "children" => 6]));
...
class Repo{
    ...
    public static function getConnnection(){
        if(!static::$pdo){
            static::$pdo = new Database();
        }
        
        return static::$pdo = new Database();
    }
