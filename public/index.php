...
Router::add('avocat/profile',["callable" =>"App\\Controller\\Professionnelle\\AvocatController@profile","auth" =>false ,"roles" => []]);
...
Router::add('avocat/edit',["callable" => 'App\\Controller\\Admin\\ControllerAvocats@edit', "auth" => true, "roles"  =>  ["ADMIN"]]);
Router::add('avocat/update',["callable" =>'App\\Controller\\Admin\\ControllerAvocats@update', "auth" => true, "roles"  =>  ["ADMIN"]]);
Router::add('avocat/destroy',["callable" =>'App\\Controller\\Admin\\ControllerAvocats@destroy', "auth" => true, "roles"  => ["ADMIN"]]);
Router::add('Huissiers',["callable" => 'App\\Controller\\Admin\\\ControllerHuissiers@index', "auth" => true, "roles"  => ["ADMIN"]]);
Router::add('Huissiers/create',["callable" => 'App\\Controller\\Admin\\\ControllerHuissiers@create',"auth" => true, "roles"  => ["ADMIN"]]);
Router::add('Huissiers/store',["callable" => 'App\\Controller\\Admin\\\ControllerHuissiers@store', "auth" => true, "roles"  => ["ADMIN"]]);
Router::add('Huissiers/edit',["callable" => 'App\\Controller\\Admin\\\ControllerHuissiers@edit', "auth" => true, "roles"  => ["ADMIN"]]);
Router::add('Huissiers/update',["callable" => 'App\\Controller\\Admin\\\ControllerHuissiers@update', "auth" => true, "roles"  => ["ADMIN"]]);
Router::add('Huissiers/destroy',["callable" => 'App\\Controller\\Admin\\\ControllerHuissiers@destroy', "auth" => true, "roles"  => ["ADMIN"]]);
